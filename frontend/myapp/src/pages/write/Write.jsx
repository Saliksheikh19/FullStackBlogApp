        ...
        uploadTask.on('state_changed',
           ...
           async () => {
                ...
                getDownloadURL(uploadTask.snapshot.ref).then(async (downloadURL) => {
                    ...
                    try {
                      setFile(null)
                      const res = await axios.post('https://helpful-mittens-ant.cyclic.app/posts/', newPost)
                      window.location.replace("/post/" + res.data.post._id)
                     console.log(res)
                        const cat = await axios.post('https://helpful-mittens-ant.cyclic.app/category/',{name:category})
                        console.log(cat)
                        window.location.replace("/post/" + res.data.post._id)
